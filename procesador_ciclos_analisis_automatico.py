...
concentracion =19.9*1e3 #[concentracion]= g/m^3 (1 g/l == 1e3 g/m^3) (Default = 10000 g/m^3)
...
encabezado = ['Nombre_archivo','Time_m_(s)','Temperatura_(ºC)','Mr_(A/m)','Hc_(kA/m)',
              'Campo_max_(A/m)','Mag_max_(A/m)','f0','mag0','dphi0','SAR_(W/g)','Tau_(s)','N','xi_M_0']
...
if Transicion_de_fase:
    ...
    resultados_out.meta['comments'] = ['Configuracion:',
                              ...
                              f'Mr_A/m_=_{Remanencia_all:.2f}',
                              f'Suceptibilidad_a_M=0_=_{xi_all:.4f}',
                              f't_hasta_1er_file_=_{delta_0:.2f}']#f'Transicion_de_fase_=_{t_tf}\n']
